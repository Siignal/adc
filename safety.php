...
<div id='content'>
	<div id='left'>
		...
		<img style="float:right;" src="../assets/img/safetytips1_n.png" />
		<h3>PROTÈGE TES INFORMATIONS PERSONNELLES</h3>
		<p>Tu ne sais jamais avec qui tu es vraiment en train de parler en ligne, donc ne donne jamais ton vrai nom, adresse, numéro de téléphone, photos ou nom de ton établissement scolaire. Partager ces informations personnelles peut te conduire à être victime d'une arnaque, d'intimidation ou de te mettre en danger.</p>
		<hr>

		<img style="float:right;" src="../assets/img/safetytips2_n2.png" />
		...
		<img style="float:right;" src="../assets/img/safetytips3_n.png" />
		<h3>NE CÈDE PAS À LA PRESSION DES AUTRES</h3>
		<p>Que tout le monde fasse quelque chose n'est pas une raison pour toi de le faire si tu n'es pas à l'aise avec cette idée.
		</p>
		<hr style="margin-top:100px;">

		<img style="float:right;" src="../assets/img/safetytips4_n.png" />
		...
		<img style="float:right;" src="../assets/img/safetytips5_n.png" />
		<h3>N'AIES PAS PEUR DE DIRE LES CHOSES!</h3>
		<p>Si quelqu'un te met mal à l'aise ou te fait peur avec des menaces dans <?= $site; ?>, signale-le immédiatement à notre équipe de modération en utilisant le bouton d'alerte.</p>
		<hr style="margin-top:90px;">

		<img style="float:right;" src="../assets/img/safetytips6_n.png" />
