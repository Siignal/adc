<?php $pagename = 'Qu\'est-ce qu\'Habboo'; 
$pageid = '7'; ?>
<?php include('template/header.php'); ?>

<div id='content'>
	<div id='left'>
		   	<h1>HABBOO, C'EST QUOI?</h1>
		   	<p><?= $site; ?> est une communauté virtuelle en ligne pixelisée sur laquelle tu pourras créer ton propre avatar, te faire des amis, discuter, créer des apparts, construire des jeux et participer aux animations officielles! Presque tout est possible sur <?= $site; ?>...</p>

		   	<h1>PLUS QU'UN JEU…</h1><img style="float:right;padding:10px;" src="assets/img/ill_15.png" />
		   	<p>Relooker ton avatar avec toutes les looks les plus fous n'est pas la seule façon de s'amuser sur <?= $site; ?>. Tu veux être l'architecte du siècle et construire des structures éblouissantes? Tu veux montrer tes compétences de fou de construction de jeu et émerveiller tes amis? Rejoins les concours! Es-tu fan de selfies et photos drôles? Notre appareil photo sera une diversion sans fin pour toi!</p>

		   	<h1>TROUVE TA PLACE</h1>
		   	<p>Tu aimes discuter et sortir avec tes amis? Les groupes <?= $site; ?>, forums et les jeux de rôles c'est la direction à prendre pour commencer. Rejoins l'armée pour faire ton devoir, enfiler ta cape et sauver l'univers. Inscris-toi et commence à explorer les possibilités infinies de rôle!</p>

		   	<h1>EXPRIME-TOI</h1><img style="float:right;padding:10px;" src="assets/img/ill_16.png" />
